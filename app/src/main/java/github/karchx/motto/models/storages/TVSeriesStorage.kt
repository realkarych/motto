...
class TVSeriesStorage {
    ...
    fun getSeries(): ArrayList<TVSeries> {
        ...
        series.add(TVSeries("13_reasons_why", "13 причин, почему", "/series/13-prichin-pochemu-13-reasons-why"))
        ...
        series.add(TVSeries("10_things_i_hate", "10 причин моей ненависти", "/series/10-prichin-moei-nenavisti-10-things-i-hate-about-you"))
        series.add(TVSeries("112263", "11/22/63", "/series/112263"))
        series.add(TVSeries("12_monkeys", "12 обезьян", "/series/12-obezyan-12-monkeys"))
        series.add(TVSeries("12_stulev", "12 стульев", "/series/12-stulev-1976"))
