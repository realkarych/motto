...
class FilmsStorage {
    ...
    fun getFilms(): ArrayList<Film> {
        ...
        films.add(Film("neprikasaemye_intouchables", "Неприкасаемые", "/movie/1-1-neprikasaemye-intouchables"))
        films.add(Film("boicovskii_klub_fight_club", "Бойцовский клуб", "/movie/boicovskii-klub-fight-club"))
        films.add(Film("bolshoi_kush_snatch", "Большой куш", "/movie/bolshoi-kush-snatch"))
        films.add(Film("brat_2", "Брат 2", "/movie/brat-2"))
        films.add(Film("vechnoe_siyanie_chistogo_razuma", "Вечное сияние чистого разума", "/movie/vechnoe-siyanie-chistogo-razuma-eternal-sunshine-of-the-spotless-mind"))
        ...
        films.add(Film("dostuchatsya_do_nebes", "Достучаться до небес", "/movie/dostuchatsya-do-nebes-knockin-on-heavens-door"))
        ...
        films.add(Film("kriminalnoe_chtivo", "Криминальное чтиво", "/movie/kriminalnoe-chtivo-pulp-fiction"))
        ...
        films.add(Film("o_chem_govoryat_muzhchiny", "О чём говорят мужчины", "/movie/o-chem-govoryat-muzhchiny"))
        films.add(Film("obshestvo_mertvyh_poetov", "Общество мёртвых поэтов", "/movie/obshestvo-mertvyh-poetov-dead-poets-society"))
        ...
        films.add(Film("tot_samyi_myunhgauzen", "Тот самый Мюнхгаузен", "/movie/tot-samyi-myunhgauzen"))
        films.add(Film("tri_metra_nad_urovnem_neba", "Три метра над уровнем неба", "/movie/tri-metra-nad-urovnem-neba-tres-metros-sobre-el-cielo"))
        films.add(Film("inside_im_dancing", "...А в душе я танцую", "/movie/a-v-dushe-ya-tancuyu-inside-im-dancing"))
